...
async function main() {
                ...
                create: [
                    {
                        ...
                        type: client_1.WithdrawalFieldType.EMAIL,
                ...
                create: [
                    {
                        ...
                        type: client_1.WithdrawalFieldType.SELECT,
                    ...
                    },
                    {
                        ...
                        type: client_1.WithdrawalFieldType.TEXT,
            ...
            data: {
                ...
                riskAssessment: {
                    create: {
                        ...
                        riskStatus: client_1.RiskStatus.CLEAR,
                        riskScore: 12,
                    },
                },
            },
    ...
    const offersList = [
        // Games
        {
            ...
            category: client_1.OfferCategory.GAMES,
            providerId: providerA.id,
            rewardPoints: 45000,
            estimatedMinutes: 120,
            difficulty: client_1.OfferDifficulty.HARD,
        ...
        },
        {
            ...
            rewardPoints: 28000,
            estimatedMinutes: 60,
            difficulty: client_1.OfferDifficulty.MEDIUM,
            countries: ['US', 'CA', 'UK'],
        ...
        },
        {
            ...
            rewardPoints: 12000,
            estimatedMinutes: 45,
            difficulty: client_1.OfferDifficulty.EASY,
        ...
        // Surveys
        {
            ...
            category: client_1.OfferCategory.SURVEYS,
        ...
        // Apps & Finance
        {
            ...
            category: client_1.OfferCategory.FINANCE,
        ...
        // Apps & Utilities
        {
            ...
            category: client_1.OfferCategory.APPS,
        ...
        },
        {
            ...
            category: client_1.OfferCategory.TRIALS,
            providerId: providerC.id,
            rewardPoints: 15000,
            estimatedMinutes: 10,
            difficulty: client_1.OfferDifficulty.EASY,
        ...
        // Shopping & Sign-up
        {
            ...
            category: client_1.OfferCategory.SHOPPING,
            providerId: providerB.id,
            rewardPoints: 32000,
            estimatedMinutes: 20,
            difficulty: client_1.OfferDifficulty.MEDIUM,
        ...
        },
        {
            ...
            category: client_1.OfferCategory.SIGN_UP,
            providerId: providerC.id,
            rewardPoints: 22000,
            estimatedMinutes: 10,
            difficulty: client_1.OfferDifficulty.EASY,
    ...
    for (const off of offersList) {
        const created = await prisma.offer.create({
            data: {
                ...off,
                cashValue: off.rewardPoints / 10000,
                status: client_1.OfferStatus.ACTIVE,
    ...
    for (let i = 0; i < 15; i++) {
        ...
        await prisma.offerCompletion.create({
            data: {
                ...
                status: client_1.OfferCompletionStatus.COMPLETED,
        ...
        await prisma.ledgerTransaction.create({
            data: {
                ...
                type: client_1.TransactionType.OFFER_REWARD,
        ...
        await prisma.notification.create({
            data: {
                userId: user.id,
                type: client_1.NotificationType.REWARD_ADDED,
        ...
        if (withdrawalAmount > 0) {
            ...
            const w = await prisma.withdrawalRequest.create({
                data: {
                    ...
                    statusHistory: {
                        create: [
                            { fromStatus: null, toStatus: client_1.WithdrawalStatus.PENDING, note: 'User submitted withdrawal request' },
                            { fromStatus: client_1.WithdrawalStatus.PENDING, toStatus: client_1.WithdrawalStatus.PROCESSING, note: 'Automated batch review approved' },
                            { fromStatus: client_1.WithdrawalStatus.PROCESSING, toStatus: client_1.WithdrawalStatus.PAID, note: 'Payment processed via mock gateway' },
                        ],
                    },
                },
            });
    ...
    await prisma.withdrawalRequest.create({
        data: {
            ...
            riskScore: 10,
            statusHistory: {
                create: [{ fromStatus: null, toStatus: client_1.WithdrawalStatus.PENDING, note: 'Awaiting admin review' }],
            },
        },
    });
    ...
    await prisma.withdrawalRequest.create({
        data: {
            ...
            statusHistory: {
                create: [
                    { fromStatus: null, toStatus: client_1.WithdrawalStatus.PENDING, note: 'Submitted' },
                    { fromStatus: client_1.WithdrawalStatus.PENDING, toStatus: client_1.WithdrawalStatus.PROCESSING, note: 'Sent to crypto gateway' },
                ],
            },
        },
    });
    ...
    for (let rank = 0; rank < top10Users.length; rank++) {
        ...
        await prisma.leaderboardSnapshot.create({
            data: {
                userId: user.id,
                metric: client_1.LeaderboardMetric.TOTAL_WITHDRAWN,
    ...
    await prisma.supportTicket.create({
        data: {
            ...
            category: client_1.TicketCategory.OFFER_ISSUE,
            status: client_1.TicketStatus.WAITING_FOR_USER,
            priority: 'normal',
            messages: {
                create: [
                    {
    ...
    await prisma.auditLog.create({
        data: {
            ...
            action: client_1.AuditAction.SETTINGS_UPDATED,
    ...
    await prisma.auditLog.create({
        data: {
            adminId: adminUser.id,
            action: client_1.AuditAction.WITHDRAWAL_METHOD_CREATED,
