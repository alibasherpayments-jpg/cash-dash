...
const INITIAL_OFFERWALLS: OfferwallItem[] = [
  {
    ...
    postbackUrl: "https://YOUR_DOMAIN/api/v1/webhooks/providers/taskwall?userid={userid}&offer_id={offer_id}&offer_name={offer_name}&payout={payout}&user_amount={user_amount}&password={password}",
  ...
  },
  {
    ...
    postbackUrl: "http://localhost:3001/api/v1/webhooks/providers/cpalead?user_id={user_id}&points={points}&tx_id={tx_id}",
  ...
  },
  {
    ...
    postbackUrl: "http://localhost:3001/api/v1/webhooks/providers/clickwall?user_id={user_id}&points={points}&tx_id={tx_id}",
