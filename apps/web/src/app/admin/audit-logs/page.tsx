                ...
                {loading ? (
                  ...
                  logs.map((log) => (
                    <tr key={log.id} className="hover:bg-muted/40 transition-colors">
                      ...
                      <td className="py-3.5 px-5 font-bold text-foreground">{log.admin}</td>
                      ...
                      <td className="py-3.5 px-5 font-mono text-muted-foreground">
                        {log.entityType} <span className="text-muted-foreground/60">({log.entityId})</span>
                      </td>
                      <td className="py-3.5 px-5 text-muted-foreground max-w-md">{log.details}</td>
                    </tr>
                  ))
                )}
              </tbody>
